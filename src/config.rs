...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("UCSN Acesso Remoto".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["178.104.55.214"];
pub const RS_PUB_KEY: &str = "2Up0FGrq1+J2QHqu9K7RJWOK6AFn0nu87chVG9B13C8=";
